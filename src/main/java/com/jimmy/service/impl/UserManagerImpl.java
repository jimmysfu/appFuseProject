...
import com.jimmy.service.UserExistsException;
import com.jimmy.service.UserManager;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.jimmy.service.UserService")
